...
@Tag(name = "통계 분석", description = "매출/예약/고객/직원/서비스 통계 분석 API")
@RestController
...
public class StatisticsController {
    ...
    @Operation(summary = "매출 분석", description = "지정 기간의 매출 상세 분석 데이터를 조회합니다.")
    @GetMapping("/revenue")
    ...
    @Operation(summary = "예약 분석", description = "지정 기간의 예약 상세 분석 데이터를 조회합니다.")
    ...
    @Operation(summary = "고객 분석", description = "지정 기간의 고객 상세 분석 데이터를 조회합니다.")
    ...
    @Operation(summary = "직원 성과", description = "지정 기간의 직원별 성과 분석 데이터를 조회합니다.")
    @GetMapping("/staff")
    ...
    @Operation(summary = "서비스 분석", description = "지정 기간의 서비스별 분석 데이터를 조회합니다.")
    @GetMapping("/services")
